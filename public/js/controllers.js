...
'use strict';angular.module('gottaGo.controllers', ['ngResource']).controller('GGMainCtrl', function($scope, Status, Que, roomNames) {
  var getQue;
  ...
  $scope.floorsArray = Status.success(function(response) {
