...
var Event, FloorStats, Que, app, config, eventLogger, express, http, mail, models, mongoStore, mongoose, nodemailer, path, routes, smtpTransport;
...
app.post('/api/event', function(req, res) {
  ...
  return eventLogger.logEvent(event, req, res, Event, FloorStats);
});
